...
import { ConfirmingNewSupplier, ConfirmingSupplierCountries } from 'onesait-api';
import { FormGroup, AbstractControl } from '@angular/forms';
import { Validators } from '@angular/forms';
import { Output } from '@angular/core';
import { FormControl } from '@angular/forms';
import { ConfirmingService, AccountsValidator } from 'onesait-core';

@Component({
  selector: 'osb-confirming-issue-orders-add-supplier',
  templateUrl: './confirming-issue-orders-add-supplier.component.html'
})
export class ConfirmingIssueOrdersComponentAddSupplierComponent implements OnInit {

  @Output() isSavedSupplier = new EventEmitter();

  newupplierObject = new ConfirmingNewSupplier;
  newSupplierForm: FormGroup;
  loading: boolean;
  streetTypes = [];
  countries: ConfirmingSupplierCountries[] = [];
  amountOrder: number;
  currencySymbol = '€';
  ...
  loadInitialData() {
    ...
    this.loading = true;
    this.confirmingService.getSupplierCountries().subscribe(result => {
