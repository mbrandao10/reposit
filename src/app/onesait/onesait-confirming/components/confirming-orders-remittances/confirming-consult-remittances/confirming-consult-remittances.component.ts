...
import { ConfirmingService, List, SearchConfig, SEARCH_CONFIG_TYPE, UtilsService } from 'onesait-core';
import { ConfirmingStatusTypes, ConfirmingRemittances, GenericListResponse } from 'onesait-api';
import * as _moment from 'moment';
const moment = _moment;

@Component({
  selector: 'osb-confirming-consult-remittances',
  templateUrl: './confirming-consult-remittances.component.html'
})
export class ConfirmingConsultRemittancesComponent implements OnInit, OnChanges {
  ...
  remittances: GenericListResponse<ConfirmingRemittances>;
  ...
  constructor(private confirmingService: ConfirmingService,
    ...
    this.listRemittances = new List(this.confirmingService, 'getRemittances');
  }
  ...
  prepareSearch() {
    ...
    this.formConfig.formsControl = [
      ...
      },
      {
        ...
        labelDiv: 'ONESAIT-CONFIRMING.ORDERS-REMITTANCES.REMITTANCES.CREATION-DATE',
      ...
      },
      {
        ...
        label: 'ONESAIT-CONFIRMING.ORDERS-REMITTANCES.REMITTANCES.STATE',
